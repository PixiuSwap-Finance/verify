...
contract FrameToken is BEP20 {
     ...
     */
    constructor() BEP20("Pixiu Token", "PIXIU") {
...
contract PixiuChef is MasterChef {
    constructor(FrameToken _frame) MasterChef(_frame, block.number, 25 * 10**18) {
